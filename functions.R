...
get.bases <- function() {
    return(rownames(Data$Current$Structures))
}
...
get.base.construction <- function(base.name) {
    base.starts <- c(get.base.metal(base.name),2,4,6)
...
get.base.production <- function(base.name) {
    base.starts <- c(get.base.metal(base.name),2,2,8,4,6)
...
get.base.structure.next.cost <- function(base.name,structure) {
    ...
    return(Data$Structures[[structure]][structure.next.level+1,'Credits'])
}
...
get.base.max.population <- function(base.name) {
    ...
    population.levels <- as.numeric(Data$Current$Structures[base.name,
        c('Urban.Structures','Orbital.Base')])
